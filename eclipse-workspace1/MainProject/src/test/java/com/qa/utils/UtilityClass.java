...
public static String[][] readExcel(String sheetname) throws IOException {
    FileInputStream fis = new FileInputStream("C:\\Users\\ADMIN\\eclipse-workspace1\\MainProject\\src\\test\\resources\\Data\\HotelAppTestData.xlsx");
	...
	public static String screenShot(String name) throws IOException {
	    ...
	    String folderPath = System.getProperty("user.dir") + "/snap/"; // <-- safer path
	    ...
	    return "snap/" + fileName; // return relative path for reports
	}
